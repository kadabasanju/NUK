...
public class ClusterAlgo {
	...
	public ClusterAlgo(Context cont)
	{
		this.context = cont;
   ...
   //Checking for time where there is no data:
   	...
   	for (int i = 0; i < cluLen; i++ )
   	{
   		...
   		{	double latAvg1=0, longAvg1=0, accuracy1 =0;
			...
			Cluster avgCluster = new Cluster(latAvg1, longAvg1, temp.getTime(),0, accuracy1 );
   			...
   			if(i==clu.size()-2)
       		{
				...
				Cluster avgClu = new Cluster(lat, longi, tempArray.get(0).getTime(),du, accu);
